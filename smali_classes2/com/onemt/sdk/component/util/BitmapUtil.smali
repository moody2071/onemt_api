.class public Lcom/onemt/sdk/component/util/BitmapUtil;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field private static COMPRESS_IMAGE_QUALITY:I = 0x50

.field public static FILE_SAVE_PATH:Ljava/lang/String; = null
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/onemt/sdk/component/util/BitmapUtil;->FILE_SAVE_PATH:Ljava/lang/String;
...
.method public static bitmapCompressTobyte(Landroid/graphics/Bitmap;)[B
    .locals 4
...
.method public static comp(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 110
    invoke-static {p0}, Lcom/onemt/sdk/component/util/BitmapUtil;->compressImage(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method public static convertUritoBitmap(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Bitmap;
    .locals 0
...
.method public static copyFile(Ljava/io/File;Ljava/io/File;Z)V
    ...
    :cond_3
    :goto_1
    invoke-static {p0, p1, p2}, Lcom/onemt/sdk/component/util/BitmapUtil;->doCopyFile(Ljava/io/File;Ljava/io/File;Z)V
...
.method public static decodeUri(Landroid/content/Context;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    .line 3
    .line 4
    invoke-static {p0, p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->getPath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 35
    :cond_0
    invoke-static {p0, p2, p3}, Lcom/onemt/sdk/component/util/BitmapUtil;->calculateInSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
...
.method private static doCopyFile(Ljava/io/File;Ljava/io/File;Z)V
    ...
    .line 51
    .line 52
    invoke-static {v0, v1}, Lcom/onemt/sdk/component/util/IOUtil;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;)J

    .line 53
    .line 54
    .line 55
    invoke-static {v1}, Lcom/onemt/sdk/component/util/IOUtil;->closeQuietly(Ljava/io/OutputStream;)V

    .line 56
    .line 57
    .line 58
    invoke-static {v0}, Lcom/onemt/sdk/component/util/IOUtil;->closeQuietly(Ljava/io/InputStream;)V
    ...
    .line 89
    .line 90
    const-string p2, "file set last modified fail:"
...
.method public static getBytes(Landroid/content/Context;Ljava/lang/String;II)[B
    .locals 1
    ...
    .line 3
    invoke-static {p0, p2, p3}, Lcom/onemt/sdk/component/util/BitmapUtil;->decodeFile(Ljava/io/File;II)Landroid/graphics/Bitmap;
    ...
    .line 4
    :cond_1
    invoke-static {p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->getPictureRotateAngle(Ljava/lang/String;)I

    move-result p1

    .line 5
    invoke-static {p1, p0}, Lcom/onemt/sdk/component/util/BitmapUtil;->rotaingBitmap(ILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    sget p3, Lcom/onemt/sdk/component/util/BitmapUtil;->COMPRESS_IMAGE_QUALITY:I
...
.method public static getBytes(Ljava/lang/String;III)[B
    .locals 8
    ...
    .line 18
    invoke-static {v0}, Lcom/onemt/sdk/component/util/FileIOUtils;->readFile2BytesByStream(Ljava/io/File;)[B
    ...
    .line 19
    :cond_2
    invoke-static {v0, p1, p2}, Lcom/onemt/sdk/component/util/BitmapUtil;->decodeFile(Ljava/io/File;II)Landroid/graphics/Bitmap;
...
.method public static getOriginalRotateBitmap(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    .locals 1
...
.method public static getPath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->getRealPathFromURI_API19(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
...
.method public static getPictureRotateAngle(Ljava/lang/String;)I
    .locals 3
...
.method public static getRealPathFromURI_API19(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 7
    .line 8
    invoke-static {p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->isExternalStorageDocument(Landroid/net/Uri;)Z
    ...
    .line 108
    :cond_2
    invoke-static {p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->isDownloadsDocument(Landroid/net/Uri;)Z
    ...
    .line 113
    .line 114
    invoke-static {p0, p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->getFilePath(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 171
    invoke-static {p0, p1, v1, v1}, Lcom/onemt/sdk/component/util/BitmapUtil;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 176
    :cond_4
    invoke-static {p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->isMediaDocument(Landroid/net/Uri;)Z
    ...
    .line 231
    .line 232
    invoke-static {p0, v1, p1, v0}, Lcom/onemt/sdk/component/util/BitmapUtil;->getDataColumn(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 248
    .line 249
    invoke-static {p1}, Lcom/onemt/sdk/component/util/BitmapUtil;->isGooglePhotosUri(Landroid/net/Uri;)Z
...
.method public static rotaingBitmap(ILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 5
    .line 6
    const-string v1, "BitmapUtil rotaingBitmap:"
...
.method public static saveFile(Landroid/content/Context;Landroid/net/Uri;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    sget-object p1, Lcom/onemt/sdk/component/util/BitmapUtil;->FILE_SAVE_PATH:Ljava/lang/String;
    ...
    invoke-static {v0, p1, p0}, Lcom/onemt/sdk/component/util/BitmapUtil;->copyFile(Ljava/io/File;Ljava/io/File;Z)V
...
.method public static saveFile(Landroid/graphics/Bitmap;)V
    ...
    sget-object v2, Lcom/onemt/sdk/component/util/BitmapUtil;->FILE_SAVE_PATH:Ljava/lang/String;
    ...
    .line 12
    invoke-static {p0, v0}, Lcom/onemt/sdk/component/util/BitmapUtil;->saveBitmap(Landroid/graphics/Bitmap;Ljava/lang/String;)V

    return-void
.end method

.method public static saveFile(Ljava/io/File;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    sget-object v1, Lcom/onemt/sdk/component/util/BitmapUtil;->FILE_SAVE_PATH:Ljava/lang/String;
    ...
    invoke-static {p0, v1, v0}, Lcom/onemt/sdk/component/util/BitmapUtil;->copyFile(Ljava/io/File;Ljava/io/File;Z)V

    return-void
.end method

.method public static saveToGallery(Landroid/graphics/Bitmap;)Ljava/io/File;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
