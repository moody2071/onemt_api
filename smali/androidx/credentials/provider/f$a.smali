.class public final Landroidx/credentials/provider/f$a;
...
# static fields
.field public static final a:Landroidx/credentials/provider/f$a;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/credentials/provider/f$a;

    invoke-direct {v0}, Landroidx/credentials/provider/f$a;-><init>()V

    sput-object v0, Landroidx/credentials/provider/f$a;->a:Landroidx/credentials/provider/f$a;
...
.method public static final a(Landroid/app/slice/Slice;)Landroidx/credentials/provider/f;
    .locals 20
    ...
    .line 266
    invoke-virtual {v0, v2, v1}, Landroidx/credentials/provider/b$a;->b(Landroid/os/Bundle;Ljava/lang/String;)Landroidx/credentials/provider/b;
    ...
    .line 270
    new-instance v0, Landroidx/credentials/provider/f;
...
.method public static final b(Landroidx/credentials/provider/f;)Z
    .locals 2
    ...
    .line 5
    .line 6
    invoke-static {p0}, Landroidx/credentials/provider/f;->a(Landroidx/credentials/provider/f;)Z
    ...
    .line 11
    .line 12
    invoke-static {p0}, Landroidx/credentials/provider/f;->b(Landroidx/credentials/provider/f;)Z
    ...
    .line 17
    :cond_0
    invoke-virtual {p0}, Landroidx/credentials/provider/f;->f()Landroid/graphics/drawable/Icon;
...
.method public static final c(Landroidx/credentials/provider/f;)Landroid/app/slice/Slice;
    .locals 16
    .param p0    # Landroidx/credentials/provider/f;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    .line 12
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->j()Ljava/lang/CharSequence;
    ...
    .line 16
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->e()Ljava/lang/CharSequence;
    ...
    .line 20
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->h()Landroid/app/PendingIntent;
    ...
    .line 24
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->i()Ljava/lang/CharSequence;
    ...
    .line 28
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->g()Ljava/time/Instant;
    ...
    .line 32
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->f()Landroid/graphics/drawable/Icon;
    ...
    .line 36
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->l()Z
    ...
    .line 177
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->k()Z
    ...
    :cond_2
    :goto_2
    invoke-virtual/range {p0 .. p0}, Landroidx/credentials/provider/f;->m()Z
