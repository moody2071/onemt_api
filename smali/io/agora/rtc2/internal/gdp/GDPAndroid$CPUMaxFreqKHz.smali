...
# static fields
.field public static freq:I = -0x1
...
.method public getCPUMaxFreqKHzSafe()I
    ...
    iget-object v0, p0, Lio/agora/rtc2/internal/gdp/GDPAndroid$CPUMaxFreqKHz;->runDone:Ljava/util/concurrent/CountDownLatch;
    ...
    const-string v1, "getCPUMaxFreqKHzSafe timeout"

    invoke-static {v0, v1}, Lio/agora/utils2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    sget v0, Lio/agora/rtc2/internal/gdp/GDPAndroid$CPUMaxFreqKHz;->freq:I
