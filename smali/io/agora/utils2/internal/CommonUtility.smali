...
.field public static final UNKNOWN_BATTERY_PERCENTAGE:I = 0xff
...
.method public static getDisplayMetrics()[I
    ...
    const-string v3, "getDisplayMetrics widthPixel: "
...
.method private static isSimulatorProperty()Z
    ...
    const-string v6, ", baseBandVersion = "
...
.method private stopMonitor()V
    ...
    invoke-static {v0, v4, v3}, Lio/agora/utils2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_5
    :goto_4
    :try_start_5
    invoke-direct {p0, v1, v2}, Lio/agora/utils2/internal/CommonUtility;->monitorOrientationChange(Landroid/content/Context;Z)V
    :try_end_5
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_5} :catch_5
...
.method public onAudioRoutingPhoneChanged(ZII)V
    ...
    const-string v3, "onAudioRoutingPhoneChanged: "
...
.method public registerSystemEventListener(Lio/agora/utils2/internal/CommonUtility$SystemEventListener;)V
    ...
    const-string v1, "registerSystemEventListener: "
...
.method public startMonitor()V
    ...
    sget-boolean v1, Lio/agora/utils2/internal/CommonUtility;->ignoreMonitor:Z

    if-eqz v1, :cond_0

    const-string v1, "ignoreMonitor in simulator, just for ut"
    ...
    invoke-static {v0, v3, v2}, Lio/agora/utils2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
