...
.method public final a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    .line 12
    .line 13
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$h;->u:Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 2
    .line 3
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$h;->q:Landroid/support/v4/media/session/MediaSessionCompat$Callback;
    ...
    .line 14
    .line 15
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$h$d;->a:Landroid/support/v4/media/session/MediaSessionCompat$h;

    .line 16
    .line 17
    new-instance v3, Landroidx/media/MediaSessionManager$a;
    ...
    .line 37
    invoke-direct {v3, v4, v5, v6}, Landroidx/media/MediaSessionManager$a;-><init>(Ljava/lang/String;II)V

    .line 38
    .line 39
    .line 40
    invoke-virtual {v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$h;->setCurrentControllerInfo(Landroidx/media/MediaSessionManager$a;)V
    ...
    .line 170
    .line 171
    invoke-virtual {v0, p1, v4}, Landroid/support/v4/media/session/MediaSessionCompat$h;->s(II)V
    ...
    .line 197
    .line 198
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$h$d;->a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    .line 342
    .line 343
    iget-object v3, p1, Landroid/support/v4/media/session/MediaSessionCompat$h$b;->b:Landroid/os/Bundle;
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$h$d;->a:Landroid/support/v4/media/session/MediaSessionCompat$h;

    .line 351
    .line 352
    invoke-virtual {p1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$h;->setCurrentControllerInfo(Landroidx/media/MediaSessionManager$a;)V
    ...
    .line 358
    .line 359
    invoke-virtual {v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$h;->setCurrentControllerInfo(Landroidx/media/MediaSessionManager$a;)V
