...
.method public synthetic constructor <init>(Lcom/facebook/AccessTokenManager$RefreshResult;Lcom/facebook/AccessToken;Lcom/facebook/AccessToken$AccessTokenRefreshCallback;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Lcom/facebook/AccessTokenManager;)V
    ...
    iput-object p5, p0, Lcom/facebook/b;->e:Ljava/util/Set;

    iput-object p6, p0, Lcom/facebook/b;->f:Ljava/util/Set;

    iput-object p7, p0, Lcom/facebook/b;->g:Ljava/util/Set;
...
.method public final onBatchCompleted(Lcom/facebook/GraphRequestBatch;)V
    ...
    iget-object v4, p0, Lcom/facebook/b;->e:Ljava/util/Set;

    iget-object v5, p0, Lcom/facebook/b;->f:Ljava/util/Set;

    iget-object v6, p0, Lcom/facebook/b;->g:Ljava/util/Set;

    iget-object v7, p0, Lcom/facebook/b;->h:Lcom/facebook/AccessTokenManager;

    move-object v8, p1

    invoke-static/range {v0 .. v8}, Lcom/facebook/AccessTokenManager;->d(Lcom/facebook/AccessTokenManager$RefreshResult;Lcom/facebook/AccessToken;Lcom/facebook/AccessToken$AccessTokenRefreshCallback;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Lcom/facebook/AccessTokenManager;Lcom/facebook/GraphRequestBatch;)V
