...
# virtual methods
.method public a(Lorg/ahocorasick/interval/Intervalable;Ljava/util/List;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public b(Lorg/ahocorasick/interval/Intervalable;Lorg/ahocorasick/interval/IntervalNode$Direction;)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public c(Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lorg/ahocorasick/interval/IntervalNode;->b(Lorg/ahocorasick/interval/Intervalable;Lorg/ahocorasick/interval/IntervalNode$Direction;)Ljava/util/List;
...
.method public d(Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public f(Lorg/ahocorasick/interval/IntervalNode;Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    .line 3
    invoke-virtual {p1, p2}, Lorg/ahocorasick/interval/IntervalNode;->g(Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
...
.method public g(Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 15
    .line 16
    invoke-virtual {p0, v1, p1}, Lorg/ahocorasick/interval/IntervalNode;->f(Lorg/ahocorasick/interval/IntervalNode;Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
    ...
    .line 20
    invoke-virtual {p0, p1, v0, v1}, Lorg/ahocorasick/interval/IntervalNode;->a(Lorg/ahocorasick/interval/Intervalable;Ljava/util/List;Ljava/util/List;)V

    .line 21
    .line 22
    .line 23
    invoke-virtual {p0, p1}, Lorg/ahocorasick/interval/IntervalNode;->d(Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
    ...
    .line 47
    .line 48
    invoke-virtual {p0, p1}, Lorg/ahocorasick/interval/IntervalNode;->c(Lorg/ahocorasick/interval/Intervalable;)Ljava/util/List;
