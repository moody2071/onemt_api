...
.method public constructor <init>(Landroid/content/Context;Landroid/graphics/Bitmap;Lcom/yalantis/ucrop/model/ImageState;Lcom/yalantis/ucrop/model/CropParameters;Lcom/yalantis/ucrop/callback/BitmapCropCallback;)V
    ...
    .line 78
    .line 79
    invoke-virtual {p4}, Lcom/yalantis/ucrop/model/CropParameters;->getmInputUri()Landroid/net/Uri;
    ...
    .line 83
    iput-object p1, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mInputUri:Landroid/net/Uri;

    .line 84
    .line 85
    invoke-virtual {p4}, Lcom/yalantis/ucrop/model/CropParameters;->getmOutputUri()Landroid/net/Uri;
    ...
    .line 89
    iput-object p1, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mOutputUri:Landroid/net/Uri;
...
.method private crop()Z
    ...
    .line 128
    invoke-virtual {v7, v0, v2, v4}, Landroid/graphics/Matrix;->setRotate(FFF)V
    ...
    .line 247
    .line 248
    iget v1, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->cropOffsetX:I

    .line 249
    .line 250
    iget v2, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->cropOffsetY:I
...
.method private saveImage(Landroid/graphics/Bitmap;)V
    ...
    .line 13
    :try_start_0
    sget-boolean v2, Lcom/yalantis/ucrop/UCrop;->isAndroidQ:Z
    ...
    .line 16
    .line 17
    invoke-static {v0}, Lcom/yalantis/ucrop/util/FileUtils;->createAndroidQUri(Landroid/content/Context;)Landroid/net/Uri;
    ...
    .line 24
    .line 25
    iput-object v2, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mOutputUri:Landroid/net/Uri;
    ...
    .line 33
    iget-object v4, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mOutputUri:Landroid/net/Uri;
    ...
    .line 75
    .line 76
    invoke-static {v0, v3}, Lcom/yalantis/ucrop/util/FileUtils;->deleteFile(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 80
    :cond_3
    iput-object v3, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mOutputUri:Landroid/net/Uri;
    :try_end_0
...
.method public onPostExecute(Ljava/lang/Throwable;)V
    ...
    .line 3
    sget-boolean p1, Lcom/yalantis/ucrop/UCrop;->isAndroidQ:Z

    if-eqz p1, :cond_0

    .line 4
    iget-object p1, p0, Lcom/yalantis/ucrop/task/BitmapCropTask;->mOutputUri:Landroid/net/Uri;
