...
.method public dispose()V
    ...
    :try_start_0
    iget-object v1, p0, Lio/agora/base/TextureBufferHelper;->handler:Landroid/os/Handler;
...
.method public parseAlphaData(Lio/agora/base/TextureBuffer;IZ)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v4, v6}, Lio/agora/base/internal/video/GlTextureFrameBuffer;-><init>(I)V
    ...
    invoke-virtual {v4, v15, v2}, Lio/agora/base/internal/video/GlTextureFrameBuffer;->setSize(II)V
    ...
    invoke-virtual {v4, v1, v6}, Landroid/graphics/Matrix;->preScale(FF)Z

    :cond_5
    const/high16 v1, -0x41000000    # -0.5f

    invoke-virtual {v4, v1, v1}, Landroid/graphics/Matrix;->preTranslate(FF)Z
    ...
    invoke-static {v4}, Lio/agora/base/internal/video/RendererCommon;->convertMatrixFromAndroidGraphicsMatrix(Landroid/graphics/Matrix;)[F
    ...
    const-string v4, "TextureBufferHelper"

    invoke-static {v4, v3}, Lio/agora/utils2/internal/Logging;->w(Ljava/lang/String;Ljava/lang/String;)V
