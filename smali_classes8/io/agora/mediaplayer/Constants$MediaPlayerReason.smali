...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4, v5}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v3, v5, v6, v7}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V
    ...
    const-string v7, "PLAYER_REASON_NO_RESOURCE"

    const/4 v8, 0x3

    const/4 v9, -0x3

    invoke-direct {v5, v7, v8, v9}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_NO_RESOURCE:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v7, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v9, "PLAYER_REASON_INVALID_MEDIA_SOURCE"

    const/4 v10, 0x4

    const/4 v11, -0x4

    invoke-direct {v7, v9, v10, v11}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_INVALID_MEDIA_SOURCE:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v9, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v11, "PLAYER_REASON_UNKNOWN_STREAM_TYPE"

    const/4 v12, 0x5

    const/4 v13, -0x5

    invoke-direct {v9, v11, v12, v13}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v9, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_UNKNOWN_STREAM_TYPE:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v11, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v13, "PLAYER_REASON_OBJ_NOT_INITIALIZED"

    const/4 v14, 0x6

    const/4 v15, -0x6

    invoke-direct {v11, v13, v14, v15}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v11, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_OBJ_NOT_INITIALIZED:Lio/agora/mediaplayer/Constants$MediaPlayerReason;
    ...
    invoke-direct {v13, v15, v14, v12}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v13, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_CODEC_NOT_SUPPORTED:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v12, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_VIDEO_RENDER_FAILED"

    const/16 v14, 0x8

    const/4 v10, -0x8

    invoke-direct {v12, v15, v14, v10}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v12, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_VIDEO_RENDER_FAILED:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v10, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_INVALID_STATE"

    const/16 v14, 0x9

    const/16 v8, -0x9

    invoke-direct {v10, v15, v14, v8}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V
    ...
    const-string v15, "PLAYER_REASON_URL_NOT_FOUND"

    const/16 v14, 0xa

    const/16 v6, -0xa

    invoke-direct {v8, v15, v14, v6}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v8, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_URL_NOT_FOUND:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v6, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_INVALID_CONNECTION_STATE"

    const/16 v14, 0xb

    const/16 v4, -0xb

    invoke-direct {v6, v15, v14, v4}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v6, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_INVALID_CONNECTION_STATE:Lio/agora/mediaplayer/Constants$MediaPlayerReason;
    ...
    invoke-direct {v4, v15, v14, v2}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAY_REASON_SRC_BUFFER_UNDERFLOW:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v2, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_INTERRUPTED"
    ...
    invoke-direct {v2, v15, v14, v4}, Lio/agora/mediaplayer/Constants$MediaPlayerReason;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_INTERRUPTED:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v4, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_NOT_SUPPORTED"
    ...
    sput-object v4, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_NOT_SUPPORTED:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v2, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_TOKEN_EXPIRED"
    ...
    sput-object v2, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_TOKEN_EXPIRED:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v4, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_IP_EXPIRED"
    ...
    sput-object v4, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->PLAYER_REASON_IP_EXPIRED:Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    new-instance v2, Lio/agora/mediaplayer/Constants$MediaPlayerReason;

    const-string v15, "PLAYER_REASON_UNKNOWN"
    ...
    new-array v4, v4, [Lio/agora/mediaplayer/Constants$MediaPlayerReason;
    ...
    sput-object v4, Lio/agora/mediaplayer/Constants$MediaPlayerReason;->$VALUES:[Lio/agora/mediaplayer/Constants$MediaPlayerReason;
