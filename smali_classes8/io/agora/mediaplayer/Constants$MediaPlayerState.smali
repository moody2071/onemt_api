...
.method public static constructor <clinit>()V
    ...
    const-string v3, "PLAYER_STATE_IDLE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v2}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v3, v5, v6, v4}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_OPENING:Lio/agora/mediaplayer/Constants$MediaPlayerState;
    ...
    const-string v10, "PLAYER_STATE_PAUSING_INTERNAL"

    const/16 v12, 0x9

    const/16 v8, 0x32

    invoke-direct {v14, v10, v12, v8}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V
    ...
    const-string v10, "PLAYER_STATE_STOPPING_INTERNAL"

    const/16 v12, 0xa

    const/16 v6, 0x33

    invoke-direct {v8, v10, v12, v6}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v8, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_STOPPING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;

    new-instance v6, Lio/agora/mediaplayer/Constants$MediaPlayerState;

    const-string v10, "PLAYER_STATE_SEEKING_INTERNAL"

    const/16 v12, 0xb

    const/16 v4, 0x34

    invoke-direct {v6, v10, v12, v4}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v6, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_SEEKING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;

    new-instance v4, Lio/agora/mediaplayer/Constants$MediaPlayerState;

    const-string v10, "PLAYER_STATE_GETTING_INTERNAL"

    const/16 v12, 0xc

    const/16 v2, 0x35

    invoke-direct {v4, v10, v12, v2}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_GETTING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;

    new-instance v2, Lio/agora/mediaplayer/Constants$MediaPlayerState;

    const-string v10, "PLAYER_STATE_NONE_INTERNAL"
    ...
    invoke-direct {v2, v10, v12, v4}, Lio/agora/mediaplayer/Constants$MediaPlayerState;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_NONE_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;

    new-instance v4, Lio/agora/mediaplayer/Constants$MediaPlayerState;

    const-string v10, "PLAYER_STATE_DO_NOTHING_INTERNAL"
    ...
    sput-object v4, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_DO_NOTHING_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;

    new-instance v2, Lio/agora/mediaplayer/Constants$MediaPlayerState;

    const-string v10, "PLAYER_STATE_SET_TRACK_INTERNAL"
    ...
    sput-object v2, Lio/agora/mediaplayer/Constants$MediaPlayerState;->PLAYER_STATE_SET_TRACK_INTERNAL:Lio/agora/mediaplayer/Constants$MediaPlayerState;

    new-instance v4, Lio/agora/mediaplayer/Constants$MediaPlayerState;

    const-string v10, "PLAYER_STATE_FAILED"
    ...
    new-array v2, v2, [Lio/agora/mediaplayer/Constants$MediaPlayerState;
    ...
    sput-object v2, Lio/agora/mediaplayer/Constants$MediaPlayerState;->$VALUES:[Lio/agora/mediaplayer/Constants$MediaPlayerState;
